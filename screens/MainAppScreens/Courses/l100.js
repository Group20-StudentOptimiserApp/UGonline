...
const L100 = ({currentUser}) => {
    ...
    const getCourse = async ()  =>{
        ...
        const querySnapshot = await getDocs(collection(db, "Courses", currentUser.Programme, "L100"));
    ...
    const getDefaultCourse = async ()  =>{
        ...
        const querySnapshot = await getDocs(collection(db, "DefaultCourses", 'ForAll', "L100"));
